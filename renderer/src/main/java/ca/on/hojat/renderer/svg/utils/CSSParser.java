...
public class CSSParser {
    ...
    static boolean mediaMatches(String mediaListStr) {
        ...
        return mediaMatches(mediaList, CSSParser.MediaType.screen);
    }

    @SuppressLint("TimberArgCount")
    private static void warn(Object... args) {
        Timber.tag(TAG).w("Ignoring @%s rule", args);
    }
    ...
    static class PseudoClassAnPlusB implements CSSParser.PseudoClass {
        ...
        public String toString() {
            ...
            return isOfType ? String.format(java.util.Locale.US, "nth-%schild(%dn%+d of type <%s>)", last, a, b, nodeName)
                    : String.format(java.util.Locale.US, "nth-%schild(%dn%+d)", last, a, b);
        }
    ...
    static class PseudoClassNot implements CSSParser.PseudoClass {
        private final java.util.List<CSSParser.Selector> selectorGroup;

        PseudoClassNot(java.util.List<CSSParser.Selector> selectorGroup) {
