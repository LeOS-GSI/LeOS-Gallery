...
class ExifParser {
    ...
    private ExifParser(InputStream inputStream, int options, ExifInterface iRef) throws IOException, ExifInvalidFormatException {
        ...
        Timber.tag(TAG).v("Reading exif...");
        mSections = new ArrayList<ExifParser.Section>(0);
     ...
     * @throws ExifInvalidFormatException
     */
    protected void skipRemainingTagsInCurrentIfd() throws java.io.IOException, ExifInvalidFormatException {
        int endOfTags = mIfdStartOffset + OFFSET_SIZE + TAG_SIZE * mNumOfTagInIfd;
        int offset = mTiffStream.getReadByteCount();
        if (offset > endOfTags) {
            return;
     ...
     */
    protected String readString(int n) throws java.io.IOException {
