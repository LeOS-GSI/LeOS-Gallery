...
public class Style implements Cloneable {
    ...
    static Style getDefaultStyle() {
        ...
        def.fillRule = Style.FillRule.NonZero;
        def.fillOpacity = 1f;
        def.stroke = null;         // none
        def.strokeOpacity = 1f;
        def.strokeWidth = new SVGBase.Length(1f);
        def.strokeLineCap = Style.LineCap.Butt;
        def.strokeLineJoin = Style.LineJoin.Miter;
        ...
        def.fontStyle = Style.FontStyle.normal;
        def.fontStretch = FONT_STRETCH_NORMAL;
        def.textDecoration = Style.TextDecoration.None;
        def.direction = Style.TextDirection.LTR;
        def.textAnchor = Style.TextAnchor.Start;
        ...
        def.stopOpacity = 1f;
        def.clipPath = null;
        def.clipRule = Style.FillRule.NonZero;
        def.mask = null;
        def.solidColor = null;
        def.solidOpacity = 1f;
        def.viewportFill = null;
        def.viewportFillOpacity = 1f;
        def.vectorEffect = Style.VectorEffect.None;
        def.imageRendering = Style.RenderQuality.auto;
        def.isolation = Style.Isolation.auto;
        def.mixBlendMode = Style.CSSBlendMode.normal;
        def.fontKerning = Style.FontKerning.auto;
        ...
        def.writingMode = Style.WritingMode.horizontal_tb;
        def.glyphOrientationVertical = Style.GlypOrientationVertical.auto;
        def.textOrientation = Style.TextOrientation.mixed;
