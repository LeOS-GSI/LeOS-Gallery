...
final class CropWindowHandler {
    ...
    private CropWindowMoveHandler.Type getRectanglePressedMoveType(
        ...
        if (ca.on.hojat.renderer.cropper.CropWindowHandler.isInCornerTargetZone(x, y, mEdges.left, mEdges.top, targetRadius)) {
            moveType = CropWindowMoveHandler.Type.TOP_LEFT;
        } else if (ca.on.hojat.renderer.cropper.CropWindowHandler.isInCornerTargetZone(
        ...
        } else if (ca.on.hojat.renderer.cropper.CropWindowHandler.isInCenterTargetZone(
                x, y, mEdges.left, mEdges.top, mEdges.right, mEdges.bottom)
                && focusCenter()) {
            moveType = CropWindowMoveHandler.Type.CENTER;
        } else if (ca.on.hojat.renderer.cropper.CropWindowHandler.isInHorizontalTargetZone(
        ...
        } else if (ca.on.hojat.renderer.cropper.CropWindowHandler.isInVerticalTargetZone(
