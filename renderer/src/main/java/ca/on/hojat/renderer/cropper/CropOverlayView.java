...
public class CropOverlayView extends View {
     ...
     */
    private ca.on.hojat.renderer.cropper.CropOverlayView.CropWindowChangeListener mCropWindowChangeListener;
     ...
     */
    public void setCropWindowChangeListener(ca.on.hojat.renderer.cropper.CropOverlayView.CropWindowChangeListener listener) {
    ...
    public boolean setMultiTouchEnabled(boolean multiTouchEnabled) {
        if (mMultiTouchEnabled != multiTouchEnabled) {
            ...
            if (mMultiTouchEnabled && mScaleDetector == null) {
                mScaleDetector = new ScaleGestureDetector(getContext(), new ca.on.hojat.renderer.cropper.CropOverlayView.ScaleListener());
            }
            return true;
        }
        return false;
