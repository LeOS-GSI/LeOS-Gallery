...
final class CropWindowMoveHandler {
     ...
     */
    private final ca.on.hojat.renderer.cropper.CropWindowMoveHandler.Type mType;
    ...
    public CropWindowMoveHandler(
            ca.on.hojat.renderer.cropper.CropWindowMoveHandler.Type type, CropWindowHandler cropWindowHandler, float touchX, float touchY) {
        mType = type;
    ...
    public void move(
        ...
        if (mType == ca.on.hojat.renderer.cropper.CropWindowMoveHandler.Type.CENTER) {
    ...
    private void moveCenter(
            android.graphics.RectF rect, float x, float y, android.graphics.RectF bounds, int viewWidth, int viewHeight, float snapRadius) {
    ...
    private void moveSizeWithFreeAspectRatio(
            android.graphics.RectF rect, float x, float y, android.graphics.RectF bounds, int viewWidth, int viewHeight, float snapMargin) {
        switch (mType) {
            case TOP_LEFT:
