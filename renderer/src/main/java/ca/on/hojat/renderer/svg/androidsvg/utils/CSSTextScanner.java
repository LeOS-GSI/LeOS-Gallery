...
public class CSSTextScanner extends TextScanner {
    ...
    private CSSTextScanner.AnPlusB nextAnPlusB() {
        ...
        CSSTextScanner.AnPlusB result;
        if (consume("odd"))
            result = new CSSTextScanner.AnPlusB(2, 1);
        else if (consume("even"))
            result = new CSSTextScanner.AnPlusB(2, 0);
        else {
            ...
            result = new CSSTextScanner.AnPlusB((a == null) ? 0 : aSign * a.value(),
...
//         int     pseudoStart = position;
        ...
        switch (identEnum) {
            ...
            case nth_last_of_type:
                ...
                CSSTextScanner.AnPlusB ab = nextAnPlusB();
                if (ab == null)
