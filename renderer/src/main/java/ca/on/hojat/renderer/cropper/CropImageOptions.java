...
public class CropImageOptions implements android.os.Parcelable {
    ...
    public static final android.os.Parcelable.Creator<CropImageOptions> CREATOR =
            new android.os.Parcelable.Creator<CropImageOptions>() {
                @Override
                public ca.on.hojat.renderer.cropper.CropImageOptions createFromParcel(android.os.Parcel in) {
                    return new ca.on.hojat.renderer.cropper.CropImageOptions(in);
                }

                @Override
                public ca.on.hojat.renderer.cropper.CropImageOptions[] newArray(int size) {
                    return new ca.on.hojat.renderer.cropper.CropImageOptions[size];
                }
            };
    ...
    public CropImageOptions() {
        ...
        snapRadius = android.util.TypedValue.applyDimension(android.util.TypedValue.COMPLEX_UNIT_DIP, 3, dm);
        touchRadius = android.util.TypedValue.applyDimension(android.util.TypedValue.COMPLEX_UNIT_DIP, 24, dm);
        ...
        borderLineThickness = android.util.TypedValue.applyDimension(android.util.TypedValue.COMPLEX_UNIT_DIP, 3, dm);
        borderLineColor = android.graphics.Color.argb(170, 255, 255, 255);
        borderCornerThickness = android.util.TypedValue.applyDimension(android.util.TypedValue.COMPLEX_UNIT_DIP, 2, dm);
        borderCornerOffset = android.util.TypedValue.applyDimension(android.util.TypedValue.COMPLEX_UNIT_DIP, 5, dm);
        borderCornerLength = android.util.TypedValue.applyDimension(android.util.TypedValue.COMPLEX_UNIT_DIP, 14, dm);
        borderCornerColor = android.graphics.Color.WHITE;

        guidelinesThickness = android.util.TypedValue.applyDimension(android.util.TypedValue.COMPLEX_UNIT_DIP, 1, dm);
        guidelinesColor = android.graphics.Color.argb(170, 255, 255, 255);
        backgroundColor = android.graphics.Color.argb(119, 0, 0, 0);

        minCropWindowWidth = (int) android.util.TypedValue.applyDimension(android.util.TypedValue.COMPLEX_UNIT_DIP, 42, dm);
        minCropWindowHeight = (int) android.util.TypedValue.applyDimension(android.util.TypedValue.COMPLEX_UNIT_DIP, 42, dm);
    ...
    protected CropImageOptions(android.os.Parcel in) {
        ...
        activityTitle = android.text.TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(in);
        activityMenuIconColor = in.readInt();
        outputUri = in.readParcelable(android.net.Uri.class.getClassLoader());
        outputCompressFormat = android.graphics.Bitmap.CompressFormat.valueOf(in.readString());
        ...
        initialCropWindowRectangle = in.readParcelable(android.graphics.Rect.class.getClassLoader());
        ...
        cropMenuCropButtonTitle = android.text.TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(in);
    ...
    public void writeToParcel(android.os.Parcel dest, int flags) {
        ...
        android.text.TextUtils.writeToParcel(activityTitle, dest, flags);
        ...
        android.text.TextUtils.writeToParcel(cropMenuCropButtonTitle, dest, flags);
