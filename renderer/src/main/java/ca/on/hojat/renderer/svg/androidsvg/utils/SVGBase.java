...
import ca.on.hojat.renderer.svg.androidsvg.utils.CSSParser.Ruleset;
...
import ca.on.hojat.renderer.svg.androidsvg.utils.CSSParser.Rule;
...
public class SVGBase {
    ...
    public static class CSSClipRect {
        ...
        CSSClipRect(Length top, Length right, SVGBase.Length bottom, Length left) {
            this.top = top;
            this.right = right;
            this.bottom = bottom;
            this.left = left;
    ...
    static abstract class GraphicsElement extends SvgConditionalElement implements SVGBase.HasTransform {
        Matrix transform;
