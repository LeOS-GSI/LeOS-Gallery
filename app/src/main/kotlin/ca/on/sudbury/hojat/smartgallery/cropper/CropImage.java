package ca.on.sudbury.hojat.smartgallery.cropper;
...
public final class CropImage {
     ...
     */
    public static void startPickImageActivity(@NonNull android.app.Activity activity) {
     ...
     */
    public static Intent getCameraIntent(@NonNull Context context, android.net.Uri outputFileUri) {
    ...
    public static List<Intent> getGalleryIntents(
        ...
        Intent galleryIntent =
                Objects.equals(action, android.content.Intent.ACTION_GET_CONTENT)
                        ? new Intent(action)
    ...
    public static boolean isExplicitCameraPermissionRequired(@NonNull Context context) {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                ...
                && context.checkSelfPermission(permission.CAMERA)
     ...
     *                activity/fragment/widget.
     */
    public static android.net.Uri getCaptureImageOutputUri(@NonNull Context context) {
        android.net.Uri outputFileUri = null;
        File getImage = context.getExternalCacheDir();
        if (getImage != null) {
            outputFileUri = android.net.Uri.fromFile(new File(getImage.getPath(), "pickImageResult.jpeg"));
        }
     ...
     */
    public static android.net.Uri getPickImageResultUri(@NonNull Context context, @Nullable Intent data) {
    ...
    public static boolean isReadExternalStoragePermissionsRequired(
            @NonNull Context context, @NonNull android.net.Uri uri) {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                && context.checkSelfPermission(permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED
     ...
     * @param uri     the result URI of image pick.
     */
    public static boolean isUriRequiresPermissions(@NonNull Context context, @NonNull android.net.Uri uri) {
        try {
     ...
     */
    public static ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder activity() {
        return new ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder(null);
    }
     ...
     * @return builder for Crop Image Activity
     */
    public static ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder activity(@Nullable android.net.Uri uri) {
        return new ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder(uri);
    }
     ...
     */
    public static ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityResult getActivityResult(@Nullable Intent data) {
        return data != null ? (ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityResult) data.getParcelableExtra(CROP_IMAGE_EXTRA_RESULT) : null;
    }
    ...
    public static final class ActivityBuilder {
        ...
        public Intent getIntent(@NonNull Context context, @Nullable Class<?> cls) {
            ...
            intent.putExtra(ca.on.sudbury.hojat.smartgallery.cropper.CropImage.CROP_IMAGE_EXTRA_BUNDLE, bundle);
            return intent;
        }
         ...
         */
        public void start(@NonNull android.app.Activity activity) {
            mOptions.validate();
         ...
         * @param activity activity to receive result
         */
        public void start(@NonNull android.app.Activity activity, @Nullable Class<?> cls) {
            mOptions.validate();
         ...
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setCropShape(@NonNull CropImageView.CropShape cropShape) {
         ...
         * <i>Default: 3dp</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setSnapRadius(float snapRadius) {
         ...
         * <i>Default: 48dp</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setTouchRadius(float touchRadius) {
         ...
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setGuidelines(@NonNull CropImageView.Guidelines guidelines) {
         ...
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setScaleType(@NonNull CropImageView.ScaleType scaleType) {
         ...
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setShowCropOverlay(boolean showCropOverlay) {
         ...
         * default: true.
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setAutoZoomEnabled(boolean autoZoomEnabled) {
         ...
         * default: true.
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setMultiTouchEnabled(boolean multiTouchEnabled) {
         ...
         * <i>Default: 4</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setMaxZoom(int maxZoom) {
         ...
         * <i>Default: 0.1</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setInitialCropWindowPaddingRatio(float initialCropWindowPaddingRatio) {
         ...
         * <i>Default: false</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setFixAspectRatio(boolean fixAspectRatio) {
         ...
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setAspectRatio(int aspectRatioX, int aspectRatioY) {
         ...
         * <i>Default: 3dp</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setBorderLineThickness(float borderLineThickness) {
         ...
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setBorderLineColor(int borderLineColor) {
         ...
         * <i>Default: 2dp</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setBorderCornerThickness(float borderCornerThickness) {
         ...
         * <i>Default: 5dp</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setBorderCornerOffset(float borderCornerOffset) {
         ...
         * <i>Default: 14dp</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setBorderCornerLength(float borderCornerLength) {
         ...
         * <i>Default: WHITE</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setBorderCornerColor(int borderCornerColor) {
         ...
         * <i>Default: 1dp</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setGuidelinesThickness(float guidelinesThickness) {
         ...
         * <i>Default: Color.argb(170, 255, 255, 255)</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setGuidelinesColor(int guidelinesColor) {
         ...
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setBackgroundColor(int backgroundColor) {
         ...
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setMinCropWindowSize(int minCropWindowWidth, int minCropWindowHeight) {
         ...
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setMinCropResultSize(int minCropResultWidth, int minCropResultHeight) {
         ...
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setMaxCropResultSize(int maxCropResultWidth, int maxCropResultHeight) {
         ...
         * <i>Default: ""</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setActivityTitle(CharSequence activityTitle) {
         ...
         * <i>Default: NONE</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setActivityMenuIconColor(int activityMenuIconColor) {
         ...
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setOutputUri(android.net.Uri outputUri) {
         ...
         * <i>Default: JPEG</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setOutputCompressFormat(Bitmap.CompressFormat outputCompressFormat) {
         ...
         * <i>Default: 90</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setOutputCompressQuality(int outputCompressQuality) {
         ...
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setRequestedSize(int reqWidth, int reqHeight) {
         ...
         * <i>Default: 0, 0 - not set, will not resize</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setRequestedSize(
         ...
         * <i>Default: false</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setNoOutputImage(boolean noOutputImage) {
         ...
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setInitialCropWindowRectangle(Rect initialCropWindowRectangle) {
         ...
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setInitialRotation(int initialRotation) {
         ...
         * <i>Default: true</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setAllowRotation(boolean allowRotation) {
         ...
         * <i>Default: true</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setAllowFlipping(boolean allowFlipping) {
         ...
         * <i>Default: false</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setAllowCounterRotation(boolean allowCounterRotation) {
         ...
         * <i>Default: 90</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setRotationDegrees(int rotationDegrees) {
         ...
         * <i>Default: false</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setFlipHorizontally(boolean flipHorizontally) {
         ...
         * <i>Default: false</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setFlipVertically(boolean flipVertically) {
         ...
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setCropMenuCropButtonTitle(CharSequence title) {
         ...
         * <i>Default: 0</i>
         */
        public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityBuilder setCropMenuCropButtonIcon(@DrawableRes int drawableResource) {
    ...
    public static final class ActivityResult extends CropImageView.CropResult implements Parcelable {
        ...
        public static final Parcelable.Creator<ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityResult> CREATOR =
                new Parcelable.Creator<ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityResult>() {
                    @Override
                    public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityResult createFromParcel(Parcel in) {
                        return new ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityResult(in);
                    }

                    @Override
                    public ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityResult[] newArray(int size) {
                        return new ca.on.sudbury.hojat.smartgallery.cropper.CropImage.ActivityResult[size];
                    }
                };
