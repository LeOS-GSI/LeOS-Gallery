...
class IntegerParser
{
    ...
    */
   static ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.IntegerParser  parseInt(String input, int startpos, int len, boolean includeSign)
   {
      int      pos = startpos;
    ...
    * Assumes maxPos will not be greater than input.length().
    */
   static ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.IntegerParser  parseHex(String input, int startpos, int len)
   {
      int   pos = startpos;
      long  value = 0;
      char  ch;
