...
public class ExifInterface {
     ...
     *
     * @see ExifInterface.SensitivityType
     * @since EXIF 2.3
     */
     ...
     * @param options    bit flag which defines which type of tags to process, see {@link ExifInterface.Options}
     * @throws IOException
    ...
    public void writeExif(final String dstFilename) throws IOException {
        Timber.i("writeExif: %s", dstFilename);
    ...
    @SuppressWarnings("unused")
    public void writeExif(final String srcFilename, final String dstFilename) throws java.io.IOException {
        Timber.i("writeExif: %s", dstFilename);
    ...
    private static int writeExif_internal(final InputStream input, final OutputStream output, ExifData exifData) throws IOException {
        ...
        if (sections.get(0).type != JpegHeader.TAG_M_JFIF) {
            Timber.w("first section is not a JFIF or EXIF tag");
    ...
    public static Date getDateTime(String dateTimeString, TimeZone timeZone) {
        ...
        @SuppressLint("SimpleDateFormat") DateFormat formatter = new SimpleDateFormat(DATETIME_FORMAT_STR);
