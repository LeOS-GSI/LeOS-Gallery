package ca.on.sudbury.hojat.smartgallery.reprint.module;
...
import ca.on.sudbury.hojat.smartgallery.reprint.core.ReprintModule;
...
public class MarshmallowReprintModule implements ReprintModule {
    ...
    void authenticate(final CancellationSignal cancellationSignal,
        ...
        final FingerprintManager.AuthenticationCallback callback =
                new MarshmallowReprintModule.AuthCallback(restartCount, restartPredicate, cancellationSignal, listener);
