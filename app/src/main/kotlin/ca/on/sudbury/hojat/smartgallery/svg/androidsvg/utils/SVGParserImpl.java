...
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.CSSParser.MediaType;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.SVGBase.Box;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.SVGBase.CSSClipRect;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.SVGBase.Colour;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.SVGBase.CurrentColor;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.SVGBase.GradientSpread;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.SVGBase.Length;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.SVGBase.PaintReference;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.SVGBase.SvgElementBase;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.SVGBase.SvgObject;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.SVGBase.SvgPaint;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.SVGBase.TextChild;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.SVGBase.TextPositionedContainer;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.SVGBase.TextRoot;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.SVGBase.Unit;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.Style.Isolation;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.Style.RenderQuality;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.Style.TextDecoration;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.Style.TextDirection;
import ca.on.sudbury.hojat.smartgallery.svg.androidsvg.utils.Style.VectorEffect;
...
class SVGParserImpl implements SVGParser {
    ...
    private SVGParserImpl.SVGElem metadataTag = null;
    ...
    private enum SVGElem {
        ...
        private static final Map<String, SVGParserImpl.SVGElem> cache = new HashMap<>();

        static {
            for (SVGParserImpl.SVGElem elem : values()) {
                if (elem == SWITCH) {
        ...
        public static SVGParserImpl.SVGElem fromString(String str) {
            // First check cache to see if it is there
            SVGParserImpl.SVGElem elem = cache.get(str);
            if (elem != null) {
                return elem;
            }
    ...
    enum SVGAttr {
        ...
        private static final Map<String, SVGParserImpl.SVGAttr> cache = new HashMap<>();

        static {
            for (SVGParserImpl.SVGAttr attr : values()) {
                if (attr == CLASS) {
        ...
        public static SVGParserImpl.SVGAttr fromString(String str) {
            // First check cache to see if it is there
            SVGParserImpl.SVGAttr attr = cache.get(str);
            if (attr != null) {
                return attr;
            }
    ...
    private static class FontWeightKeywords {
        private static final Map<String, Float> fontWeightKeywords = new java.util.HashMap<>(4);
    ...
    public SVGBase parseStream(InputStream is) throws SVGParseException {
        ...
        try {
            ...
            Timber.tag(TAG).e(e, "Error occurred while performing check for entities.  File may not be parsed correctly if it contains entity definitions.");
            parseUsingXmlPullParser(is);
            return svgDocument;
        } finally {
            try {
                ...
                Timber.tag(TAG).e("Exception thrown closing input stream");
            }
        }
    }
     ...
     */
    private static class XPPAttributesWrapper implements org.xml.sax.Attributes {
    ...
    private void parseUsingXmlPullParser(java.io.InputStream is) throws SVGParseException {
        try {
            XmlPullParser parser = Xml.newPullParser();
            SVGParserImpl.XPPAttributesWrapper attributes = new SVGParserImpl.XPPAttributesWrapper(parser);
    ...
    private void parseUsingSAX(InputStream is) throws SVGParseException {
        try {
            ...
            SVGParserImpl.SAXHandler handler = new SVGParserImpl.SAXHandler();
    ...
    private void startElement(String uri, String localName, String qName, Attributes attributes) throws SVGParseException {
        ...
        SVGParserImpl.SVGElem elem = SVGParserImpl.SVGElem.fromString(tag);
        switch (elem) {
            case svg:
                svg(attributes);
                break;
    ...
    private void endElement(String uri, String localName, String qName) throws SVGParseException {
        ...
        String tag = (localName.length() > 0) ? localName : qName;
        switch (SVGParserImpl.SVGElem.fromString(tag)) {
            case title:
            case desc:
                inMetadataElement = false;
                if (metadataElementContents != null) {
                    if (metadataTag == SVGParserImpl.SVGElem.title)
                        svgDocument.setTitle(metadataElementContents.toString());
                    else if (metadataTag == SVGParserImpl.SVGElem.desc)
    ...
    private void parseAttributesSVG(SVGBase.Svg obj, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            switch (SVGParserImpl.SVGAttr.fromString(attributes.getLocalName(i))) {
                case x:
    ...
    private void a(org.xml.sax.Attributes attributes) throws SVGParseException {
        debug("<a>");
    ...
    private void parseAttributesPolyLine(SVGBase.PolyLine obj, Attributes attributes, String tag) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            if (SVGParserImpl.SVGAttr.fromString(attributes.getLocalName(i)) == SVGParserImpl.SVGAttr.points) {
    ...
    private void symbol(org.xml.sax.Attributes attributes) throws SVGParseException {
        debug("<symbol>");
    ...
    private void marker(org.xml.sax.Attributes attributes) throws SVGParseException {
        debug("<marker>");
    ...
    private void parseAttributesMarker(SVGBase.Marker obj, org.xml.sax.Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String val = attributes.getValue(i).trim();
            switch (SVGParserImpl.SVGAttr.fromString(attributes.getLocalName(i))) {
                case refX:
    ...
    private void linearGradient(org.xml.sax.Attributes attributes) throws SVGParseException {
    ...
    private void parseAttributesGradient(SVGBase.GradientElement obj, org.xml.sax.Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String val = attributes.getValue(i).trim();
            switch (SVGParserImpl.SVGAttr.fromString(attributes.getLocalName(i))) {
                case gradientUnits:
    ...
    private void parseAttributesLinearGradient(SVGBase.SvgLinearGradient obj, org.xml.sax.Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String val = attributes.getValue(i).trim();
            switch (SVGParserImpl.SVGAttr.fromString(attributes.getLocalName(i))) {
                case x1:
    ...
    private void radialGradient(org.xml.sax.Attributes attributes) throws SVGParseException {
    ...
    private void parseAttributesRadialGradient(SVGBase.SvgRadialGradient obj, org.xml.sax.Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String val = attributes.getValue(i).trim();
            switch (SVGParserImpl.SVGAttr.fromString(attributes.getLocalName(i))) {
                case cx:
    ...
    private void stop(org.xml.sax.Attributes attributes) throws SVGParseException {
        debug("<stop>");
    ...
    private void parseAttributesStop(SVGBase.Stop obj, org.xml.sax.Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String val = attributes.getValue(i).trim();
            //noinspection SwitchStatementWithTooFewBranches
            switch (SVGParserImpl.SVGAttr.fromString(attributes.getLocalName(i))) {
    ...
    private void solidColor(org.xml.sax.Attributes attributes) throws SVGParseException {
        debug("<solidColor>");
    ...
    private void clipPath(org.xml.sax.Attributes attributes) throws SVGParseException {
        debug("<clipPath>");
    ...
    private void parseAttributesClipPath(SVGBase.ClipPath obj, org.xml.sax.Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String val = attributes.getValue(i).trim();
            //noinspection SwitchStatementWithTooFewBranches
            switch (SVGParserImpl.SVGAttr.fromString(attributes.getLocalName(i))) {
    ...
    private void textPath(org.xml.sax.Attributes attributes) throws SVGParseException {
        debug("<textPath>");
    ...
    private void parseAttributesTextPath(SVGBase.TextPath obj, org.xml.sax.Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String val = attributes.getValue(i).trim();
            switch (SVGParserImpl.SVGAttr.fromString(attributes.getLocalName(i))) {
                case href:
    ...
    private void pattern(org.xml.sax.Attributes attributes) throws SVGParseException {
        debug("<pattern>");
    ...
    private void parseAttributesPattern(SVGBase.Pattern obj, org.xml.sax.Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String val = attributes.getValue(i).trim();
            switch (SVGParserImpl.SVGAttr.fromString(attributes.getLocalName(i))) {
                case patternUnits:
    ...
    private void view(org.xml.sax.Attributes attributes) throws SVGParseException {
        debug("<view>");
    ...
    private void mask(org.xml.sax.Attributes attributes) throws SVGParseException {
        debug("<mask>");
    ...
    private void parseAttributesMask(SVGBase.Mask obj, org.xml.sax.Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String val = attributes.getValue(i).trim();
            switch (SVGParserImpl.SVGAttr.fromString(attributes.getLocalName(i))) {
                case maskUnits:
    ...
    private void parseAttributesCore(SvgElementBase obj, org.xml.sax.Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
     ...
     */
    private void parseAttributesStyle(SvgElementBase obj, org.xml.sax.Attributes attributes) {
        for (int i = 0; i < attributes.getLength(); i++) {
            String val = attributes.getValue(i).trim();
    ...
    private void parseAttributesViewBox(SVGBase.SvgViewBoxContainer obj, org.xml.sax.Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String val = attributes.getValue(i).trim();
            switch (SVGParserImpl.SVGAttr.fromString(attributes.getLocalName(i))) {
                case viewBox:
    ...
    private void parseAttributesTransform(SVGBase.HasTransform obj, org.xml.sax.Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            if (SVGParserImpl.SVGAttr.fromString(attributes.getLocalName(i)) == SVGParserImpl.SVGAttr.transform) {
    ...
    private android.graphics.Matrix parseTransformList(String val) throws SVGParseException {
    ...
    static Length parseLength(String val) throws SVGParseException {
        ...
        if (lastChar == '%') {
            ...
            try {
                unit = Unit.valueOf(unitStr.toLowerCase(java.util.Locale.US));
            } catch (IllegalArgumentException e) {
     ...
     */
    private static java.util.List<Length> parseLengthList(String val) throws SVGParseException {
        if (val.length() == 0)
            throw new SVGParseException("Invalid length list (empty string)");

        java.util.List<Length> coords = new java.util.ArrayList<>(1);
    ...
    private static float parseFloat(String val, int len) throws SVGParseException {
        NumberParser np = new NumberParser();
        float num = np.parseNumber(val, 0, len);
        if (!Float.isNaN(num)) {
            return num;
        } else {
    ...
    static Colour parseColour(String val) {
        ...
        String valLowerCase = val.toLowerCase(java.util.Locale.US);
    ...
    private static Colour parseColourKeyword(String nameLowerCase) {
        Integer col = SVGParserImpl.ColourKeywords.get(nameLowerCase);
    ...
    static void parseFont(Style style, String val) {
        ...
        while (true) {
            ...
            if (fontWeight == null && SVGParserImpl.FontWeightKeywords.contains(item)) {
                fontWeight = SVGParserImpl.FontWeightKeywords.get(item);
                continue;
            }
            if (fontStyle == null) {
            ...
            if (fontStretch == null && SVGParserImpl.FontStretchKeywords.contains(item)) {
                fontStretch = SVGParserImpl.FontStretchKeywords.get(item);
                continue;
            }
    ...
    static java.util.List<String> parseFontFamily(String val) {
        java.util.List<String> fonts = null;
        TextScanner scan = new TextScanner(val);
        while (true) {
    ...
    static Float parseFontWeight(String val) {
        Float result = SVGParserImpl.FontWeightKeywords.get(val);
        if (result == null) {
            // Check for a number
            TextScanner scan = new TextScanner(val);
    ...
    static Float parseFontStretch(String val) {
        Float result = SVGParserImpl.FontStretchKeywords.get(val);
        if (result == null) {
    ...
    static Length[] parseStrokeDashArray(String val) {
        ...
        java.util.List<Length> dashes = new java.util.ArrayList<>();
        dashes.add(dash);
        while (!scan.empty()) {
            scan.skipCommaWhitespace();
        ...
        while (true) {
            ...
            switch (pathCommand) {
                ...
                case 'm':
                    ...
                    if (Float.isNaN(y)) {
                        Timber.tag(TAG).e("Bad path coords for " + ((char) pathCommand) + " path segment");
                        return path;
                    }
