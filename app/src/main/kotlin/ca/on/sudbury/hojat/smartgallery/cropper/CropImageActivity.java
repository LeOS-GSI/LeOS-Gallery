...
public class CropImageActivity extends AppCompatActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            if (mCropImageUri == null || mCropImageUri.equals(android.net.Uri.EMPTY)) {
    ...
    @Override
    public void onSetImageUriComplete(CropImageView view, android.net.Uri uri, Exception error) {
        if (error == null) {
    ...
    protected void cropImage() {
        if (mOptions.noOutputImage) {
            ...
            android.net.Uri outputUri = getOutputUri();
    ...
    protected android.net.Uri getOutputUri() {
        android.net.Uri outputUri = mOptions.outputUri;
        if (outputUri == null || outputUri.equals(android.net.Uri.EMPTY)) {
            try {
                String ext =
                        mOptions.outputCompressFormat == Bitmap.CompressFormat.JPEG
                                ? ".jpg"
                                : mOptions.outputCompressFormat == Bitmap.CompressFormat.PNG ? ".png" : ".webp";
                outputUri = android.net.Uri.fromFile(File.createTempFile("cropped", ext, getCacheDir()));
            } catch (IOException e) {
     ...
     */
    protected void setResult(android.net.Uri uri, Exception error, int sampleSize) {
     ...
     */
    protected Intent getResultIntent(android.net.Uri uri, Exception error, int sampleSize) {
