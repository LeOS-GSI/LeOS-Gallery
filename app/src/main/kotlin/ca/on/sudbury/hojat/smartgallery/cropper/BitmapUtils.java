...
final class BitmapUtils {
     ...
     */
    static BitmapUtils.RotateBitmapResult rotateBitmapByExif(Bitmap bitmap, Context context, Uri uri) {
     ...
     * New bitmap is created and the old one is recycled.
     */
    static BitmapUtils.RotateBitmapResult rotateBitmapByExif(Bitmap bitmap, androidx.exifinterface.media.ExifInterface exif) {
        int degrees;
        int orientation =
