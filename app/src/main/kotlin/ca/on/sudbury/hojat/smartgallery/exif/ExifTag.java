...
public class ExifTag {
    ...
    private static final java.text.SimpleDateFormat TIME_FORMAT = new SimpleDateFormat("yyyy:MM:dd kk:mm:ss");
    private static java.nio.charset.Charset US_ASCII = Charset.forName("US-ASCII");
    // Exif TagId
    ...
    public boolean setTimeValue(long time) {
        ...
        synchronized (TIME_FORMAT) {
            return setValue(TIME_FORMAT.format(new java.util.Date(time)));
        }
    }
