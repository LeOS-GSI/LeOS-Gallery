...
class IfdData {
    ...
    private final java.util.Map<Short, ExifTag> mExifTags = new java.util.HashMap<Short, ExifTag>();
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ca.on.sudbury.hojat.smartgallery.exif.IfdData) {
            ca.on.sudbury.hojat.smartgallery.exif.IfdData data = (ca.on.sudbury.hojat.smartgallery.exif.IfdData) obj;
