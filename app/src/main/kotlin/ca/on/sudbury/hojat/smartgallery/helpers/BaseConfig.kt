...
open class BaseConfig(val context: Context) {
    ...
    fun isFolderProtected(path: String) =
        getFolderProtectionType(path) != ProtectionState.ProtectionNone.id
    ...
    fun getFolderProtectionType(path: String) = prefs.getInt(
        ...
        ProtectionState.ProtectionNone.id
    )
    ...
    fun saveCustomSorting(path: String, value: Int) {
        if (path.isEmpty()) {
            ...
            prefs.edit().putInt(
                SORT_FOLDER_PREFIX + path.lowercase(Locale.getDefault()),
                value
            ).apply()
        }
    }
    ...
    fun removeCustomSorting(path: String) {
        prefs.edit()
            .remove(SORT_FOLDER_PREFIX + path.lowercase(Locale.getDefault()))
            .apply()
    }
