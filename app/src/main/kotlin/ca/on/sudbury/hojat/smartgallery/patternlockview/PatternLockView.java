package ca.on.sudbury.hojat.smartgallery.patternlockview;
...
import ca.on.sudbury.hojat.smartgallery.patternlockview.utils.ResourceUtils;
...
public class PatternLockView extends android.view.View {
    ...
    public PatternLockView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mAspectRatio = typedArray.getInt(R.styleable.PatternLockView_aspectRatio,
                    PatternLockView.AspectRatio.ASPECT_RATIO_SQUARE);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int newHeight;
        switch (mAspectRatio) {
            case PatternLockView.AspectRatio.ASPECT_RATIO_SQUARE:
